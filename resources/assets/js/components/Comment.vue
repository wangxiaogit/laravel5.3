            ...
            <div :class="contentWrapperClass">
                            ...
                            <span class="pull-right operate">
                                <span class="vote-button">
                                    <a href="javascript:;" @click="like(index)" v-if="username != comment.username">
                                        ...
                                        <i class="ion-happy text-primary" v-if="comment.like"></i>
                                        <small v-if="comment.like">{{ comment.like_num }}</small>
                                    </a>
                                    <a href="javascript:;" @click="like(index)" v-if="username != comment.username">
                                        <i class="ion-sad-outline" v-if="!comment.like"></i>
                                        <i class="ion-sad text-danger" v-else></i>
                                    </a>
                                </span>
                ...
                <form class="form-horizontal" style="margin-top: 30px;" @submit.prevent="comment" v-if="canComment">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="content" rows="5" name="content" v-model="content" placeholder="Markdown"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
